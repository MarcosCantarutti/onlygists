...
import PublicHeadlineEmpty from '@/modules/users/components/PublicHeadlineEmpty/PublicHeadlineEmpty.vue'
...
const route = useRoute() // definição, objeto, propriedade, valores etc
const router = useRouter() // comportamento
