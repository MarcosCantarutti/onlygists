  ...
  <div class="flex flex-col gap-4">
    <div class="flex flex-col md:flex-row gap-2">
      <div class="flex flex-col gap-2 flex-1">
        ...
        <InputText id="name" placeholder="Marcos Cantarutti" v-model="user.name" />
        <small v-if="props.errors?.name">{{ props.errors?.name._errors[0] }}</small>
      </div>

      <div class="flex flex-col gap-2 flex-1">
        <label for="site">Site</label>
        <InputText id="site" placeholder="marcoscantarutti.com.br" v-model="user.site" />
    ...
    <div class="flex flex-col md:flex-row gap-2">
      <div class="flex flex-col gap-2 flex-1">
        ...
        <InputText id="bio" placeholder="Developer" v-model="user.bio" />
